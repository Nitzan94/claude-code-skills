...
| [skillify](skills/skillify/) | Turns the session you just finished into a reusable skill. Reads the JSONL, interviews you in four structured rounds, writes a clean SKILL.md with per-step success criteria. |
